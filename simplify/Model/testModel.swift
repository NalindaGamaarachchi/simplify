...
struct TestModels {
    ...
    init() {
        ...
        let chair1 = Product(id: 01, name: "Chair 01", category: .chair, image: "chair_swan", price: 1000, description: "", scale: 1)
        let chair2 = Product(id: 02, name: "Chair 02", category: .chair, image: "chair", price: 1000, description: "", scale: 1)
        let chair3 = Product(id: 03, name: "Chair 03", category: .chair, image: "chair", price: 1000, description: "", scale: 1)
        let chair4 = Product(id: 04, name: "Chair 04", category: .chair, image: "chair", price: 1000, description: "", scale: 1)
